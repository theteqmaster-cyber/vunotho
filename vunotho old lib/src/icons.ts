/**
 * VUNOTHO TYPED ICON ENGINE
 * Standardized Lucide SVG icons with customizable stroke and sizes.
 */

export class VunothoIcons {
  private icons: Record<string, string> = {
    ...
    landmark: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="3" x2="21" y1="22" y2="22"/><line x1="6" x2="6" y1="18"/><line x1="10" x2="10" y1="18"/><line x1="14" x2="14" y1="18"/><line x1="18" x2="18" y1="18"/><polygon points="12 2 20 7 4 7"/></svg>',
    ...
    receipt: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1-2-1Z"/><path d="M16 8h-8"/><path d="M16 12h-8"/><path d="M12 16h-4"/></svg>',
  ...
  get(name: string, customClass = '', size = 18): string {
    const raw = this.icons[name] || this.icons.sprout;
    return raw.replace('<svg ', `<svg class="${customClass}" style="width:${size}px;height:${size}px;display:inline-block;vertical-align:middle;" `);
  }
}

export const vunothoIcons = new VunothoIcons();
if (typeof window !== 'undefined') {
  (window as any).vunothoIcons = vunothoIcons;
}
